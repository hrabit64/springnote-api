...
public class PostCreateRequestControllerDto {
    ...
    @Max(value = DBTypeSize.TINYINT, message = "시리즈 ID의 형식이 올바르지 않습니다.")
    ...
    public PostCreateRequestServiceDto toServiceDto() {
        return PostCreateRequestServiceDto.builder()
                .seriesId(seriesId)
